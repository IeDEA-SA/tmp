...
>
> Follow [these instructions](https://happygitwithr.com/https-pat#credentials-package) using the `credentials` 📦 to create, store and make your PAT available to your R session. 
> 
